...
import { ChefHat, ChevronRight, Lock, LogOut, Pencil, Trash2, User } from 'lucide-react-native';
      ...
      {carte.is_mine ? (
        <>
          ...
          <Pressable
            ...
            style={[tw`w-16 items-center justify-center rounded-r-2xl`, { backgroundColor: '#A30000' }]}
          >
        ...
        <Pressable
          ...
          style={[tw`w-20 items-center justify-center rounded-r-2xl`, { backgroundColor: '#A30000' }]}
        >
          <LogOut size={16} color="white" />
          <Text style={tw`text-[10px] text-white mt-1`}>退出</Text>
        </Pressable>
      )}
    </View>
  );
